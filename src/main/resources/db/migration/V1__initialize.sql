...
('user', '$2a$10$/x7WHsqY1YrqLQ07q.pdS.x9i5iwJIcP3ufWg9Bu15efxEtZpKwta', 'user', 'user', 'user@gmail.com', '+79772898266');
-- user pass 111
...
(2, "00000013", "Ноутбук Lenovo V130 15", "Коротко: Ноутбук, как ноутбук, хорошо подходит для работы", "Подробное описание Ноутбук Lenovo V130 15", 10.00),
(2, "00000014", "Ноутбук DELL INSPIRON 5370", "Коротко: Качество сборки, цена, набор компонетов на высшем уровне", "Подробное описание Ноутбук DELL INSPIRON 5370", 11.00),
(2, "00000015", "Ноутбук ASUS VivoBook S15 S510UN", "Коротко: Для размера экрана в 15\" -- очень легкий", "Подробное описание Ноутбук ASUS VivoBook S15 S510UN", 12.00);
...
VALUES
(1, "112345, Москва, Краснодонская 12, кв. 54"),
(1, "112234, Москва, Ленинские горы 1, кв. 1"),
(2, "112345, Москва, Краснодонская 12, кв. 55"),
(2, "112234, Москва, Ленинские горы 1, кв. 2");